...
static const uint8_t font8x8[FONT8X8_LAST - FONT8X8_FIRST + 1][8] = {
    /* 0x20 ' ' */
    ...
    /* 0x25 '%' */
    { 0x64, 0x68, 0x08, 0x10, 0x20, 0x58, 0x4C, 0x00 },
    /* 0x26 '&' */
    { 0x30, 0x48, 0x50, 0x30, 0x54, 0x48, 0x34, 0x00 },
    /* 0x27 '\'' */
...
const uint8_t *font8x8_get_glyph(char character)
{
    ...
    return font8x8[code - FONT8X8_FIRST];
}
